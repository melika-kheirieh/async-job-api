...
![CI](https://github.com/melika-kheirieh/async-job-api/actions/workflows/ci.yml/badge.svg)
...
This project demonstrates how a backend API can accept long-running work, persist job state, delegate execution to a worker, and expose job progress through a polling endpoint.
